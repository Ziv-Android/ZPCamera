...
/**
 * SharedPreference Operation Class,Apply the method to put or get or remove data,you can define filename or default filename(share_data);
 * 
 * @author Ziv
 *
 */
public class SharedPreferenceUtil {
	...
	/**
	 * Used to put data to SharedPreference ,you can set save name(fileName)
	 * @param context
	 * @param fileName
	 * @param key
	 * @param object
	...
	/**
	 * Used to get data to SharedPreference ,you can set fileName which you want to get data;
	 * @param context
	 * @param fileName
	 * @param key
	 * @param defaultObject
	...
	/**
	 * Used to remove a key values have corresponding values
	 * 
	 * @param context
	 * @param key
	 */
	 ...
	 * @param object
	 */
	public static void setComplexObject(Context context, String key, Object object) {
		setComplexObject(context, FILE_NAME, key, object);
	}

	public static void setComplexObject(Context context, String fileName, String key, Object object) {
		SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
	...
	public static <T> T getComplextObject(Context context, String key) {
		return getComplexObject(context, FILE_NAME, key);
	}

	@SuppressWarnings("unchecked")
	public static <T> T getComplexObject(Context context, String fileName, String key) {
		SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
		if (sp.contains(key)) {
